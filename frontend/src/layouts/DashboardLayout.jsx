...
const DashboardLayout = ({ children }) => {
  ...
  const getNotificationTarget = (notif) => {
    ...
    const targets = {
      ...
      document_template: '/student/document-workspace',
      project_milestone: '/student/document-workspace',
      milestone_submission: '/student/document-workspace',
      mentor_review: '/student/document-workspace',
